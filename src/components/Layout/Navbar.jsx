            ...
            <nav
                ...
                <div
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <Link href={`/contact`} onClick={handleIsOpenClick}
                        ...
                        <Link href={`/login`} onClick={handleIsOpenClick}
                              className="block px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100">Se
                            connecter</Link>
                        <Link href={`/register`} onClick={handleIsOpenClick}
                        ...
                        <div className="my-auto">
                            <Link href={`/`} className="pr-3">
                                <FontAwesomeIcon icon={faLinkedinIn} className="fa-xl text-stone-500"/>
                            </Link>
                            <Link href={`/`} className="pr-3">
                                <FontAwesomeIcon icon={faInstagram} className="fa-xl text-stone-500"/>
                            </Link>
                            <Link href={`/`} className="pr-3">
                                <FontAwesomeIcon icon={faFacebookF} className="fa-xl text-stone-500"/>
                            </Link>
                        </div>
                    </div>
                </div>
