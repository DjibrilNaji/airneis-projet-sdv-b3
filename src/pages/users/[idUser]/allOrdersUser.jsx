...
import ListOrders from "@/web/components/ListOrders.jsx"
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      filteredOrders.map((order) =>
        Year.includes(new Date(order.dateOfOrder).getFullYear()) === true
          ? ""
          : Year.push(new Date(order.dateOfOrder).getFullYear())
      )
    }
