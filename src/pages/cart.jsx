...
const productInCart = [
  {
    ...
    img: (
      <Image
        src={Image2}
        alt="img1"
        className="w-14 h-20 object-cover md:w-24 md:h-26 rounded-lg"
      />
    ),
    name: "Nom produit 1",
    description:
...
const Cart = () => {
  return (
    <>
      <Navbar />
      <h1 className="flex py-4 pl-3 text-stone-400 text-3xl font-bold md:justify-center">
        Panier
      </h1>
      <section className="p-2 lg:grid lg:grid-cols-2 grid-rows-4 grid-flow-col container mx-auto">
        ...
        <div className="lg:pr-8 lg:pl-8">
          ...
          <button className="flex justify-center lg:col-start-2 lg:row-span-1 m-auto w-full border-2 border-black text-lg font-bold p-4 bg-stone-400 rounded-xl uppercase">
            Passer la commande alexis
          </button>
        </div>
      </section>
    </>
