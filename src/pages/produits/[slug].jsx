    ...
    return (
        <>
            <div className="hidden md:flex items-center justify-center">
                ...
                <Image src={Image2} alt="slide 1" className="h-80 w-full object-cover"/>
            </div>
            ...
            <div className="md:flex md:pl-7">
                <div className="hidden md:block w-2/6">
                    <Carousel>
                        <Image src={Image2} alt="slide 1" className="h-96 object-cover"/>
                        <Image src={Image2} alt="slide 2" className="h-96 object-cover"/>
                        <Image src={Image2} alt="slide 3" className="h-96 object-cover"/>
                    </Carousel>
